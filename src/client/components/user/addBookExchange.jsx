            ...
            <Col xs={9}>
              ...
              <div>
                <div class="input-group mb-1 mt-3 ">
                  <input type="text" class="form-control" placeholder="Unesite tag" aria-describedby="basic-addon2" value={this.state.tagInputValue} onChange={this.handleTagChange} />
                  <div class="input-group-append ml-2" >
                    <button variant="primary" type="button" onClick={this.addTagToArray} >Dodajte tag</button>

                  </div>
                </div>
                <text>Pritiskom na odredjeni tag on se brise.  </text>
                <br />
